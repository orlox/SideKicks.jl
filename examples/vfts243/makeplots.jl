...
plotting_props = SideKicks.createPlottingProps([
    ...
    #[:e_f,    1,        [0,0.1],        L"e_f"],
    #[:m2_i,     m_sun,    missing,         L"M_2  \;[M_{\odot}]"],
    [:m2_i,     m_sun,    [0,25],         L"M_2  \;[M_{\odot}]"],
    [:dm2,    m_sun,    [0, 4],        L"ΔM_2  \;[M_{\odot}]"],
    #[:dm2,    m_sun,    missing,        L"ΔM_2  \;[M_{\odot}]"],
    [:P_f,      day,      [8,12],        L"P  \;[\mathrm{days}]"],
    #[:a_f,      r_sun,    missing,        L"a  \;[R_{odot}]"],
...
plotting_props = SideKicks.createPlottingProps([
    ...
    [:i_f,   degree,    missing, L"i_f"],
    [:ω_f,   degree,    missing, L"ω_f"],
    [:Ω_f,   degree,    missing, L"Ω_f"],
])
